...
import com.xml.portal.poverenik.security.auth.RestAuthenticationEntryPoint;
import com.xml.portal.poverenik.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
    	...
    	web.ignoring().antMatchers(HttpMethod.POST, "/registracija");
		web.ignoring().antMatchers(HttpMethod.POST, "/prijava");
