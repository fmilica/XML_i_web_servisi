...
public class ZahtevService extends Service {
    ...
    public final static QName SERVICE = new QName("http://zahtev", "ZahtevService");
    public final static QName ZahtevServiceSoapBinding = new QName("http://zahtev", "ZahtevServiceSoapBinding");
    static {
