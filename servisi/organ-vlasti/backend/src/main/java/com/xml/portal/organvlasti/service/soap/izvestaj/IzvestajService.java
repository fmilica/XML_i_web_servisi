...
public class IzvestajService extends Service {
    ...
    public final static QName SERVICE = new QName("http://izvestaj-service", "IzvestajService");
    public final static QName IzvestajServiceSoapBinding = new QName("http://izvestaj-service", "IzvestajServiceSoapBinding");
    static {
