...
@XmlRootElement(name = "Postupak_zalioca", namespace = "http://resenje")
public class PostupakZalioca {

    @XmlElement(name = "Podnosenje_zalbe", namespace = "http://resenje", required = true)
    protected PostupakZalioca.PodnosenjeZalbe podnosenjeZalbe;
    @XmlElement(name = "Podnosenje_zahteva", namespace = "http://resenje", required = true)
