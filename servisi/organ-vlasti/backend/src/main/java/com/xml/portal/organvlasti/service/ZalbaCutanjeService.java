...
import com.xml.portal.organvlasti.data.dao.zalba_cutanje.ListaZalbiCutanje;
...
import com.xml.portal.organvlasti.dto.pretraga.ZalbaCutanjePretraga;

@RestController
@RequestMapping(value = "organvlasti/zalba-cutanje", produces = MediaType.APPLICATION_XML_VALUE)
...
public class ZalbaCutanjeService {
    ...
    */
	...
	public ResponseEntity<Object> generisiJSON(@PathVariable("id") String id) throws Exception {
    	...
    	String path = QueryMetadata.generisiJSON("/organvlasti/ZalbaCutanje", "http://zalbacutanje", id);
