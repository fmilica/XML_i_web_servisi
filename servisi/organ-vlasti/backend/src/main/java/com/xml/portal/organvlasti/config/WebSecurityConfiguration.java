package com.xml.portal.organvlasti.config;
...
import com.xml.portal.organvlasti.security.TokenUtils;
import com.xml.portal.organvlasti.security.auth.RestAuthenticationEntryPoint;
import com.xml.portal.organvlasti.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private KorisnikBusiness jwtUserDetailsService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                // svim korisnicima dopusti da pristupe putanji /auth/**   /organvlasti/korisnik
