...
import com.xml.portal.poverenik.data.dao.NSPrefixMapper;
...
import com.xml.portal.poverenik.data.metadatadb.util.MetadataExtractor;
...
public class StoreMetadata {
	...
	public static void store(Object xmlToStore) throws IOException, SAXException, TransformerException, JAXBException {
		...
		if (xmlToStore instanceof GenericXML) {
			...
			SPARQL_NAMED_GRAPH_URI = "/poverenik/" + xmlToStore.getClass().getSimpleName();
		} else {
			xmlContent = convertToInputStream((Document) xmlToStore);
			SPARQL_NAMED_GRAPH_URI = "/poverenik/Resenje";
		}
