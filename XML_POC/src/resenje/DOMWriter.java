...
public class DOMWriter {
	...
	public void generateDOM() {
		...
		fakultet.appendChild(document.createTextNode("Fakultet tehniÄ�kih nauka"));
		institucija.appendChild(fakultet);
		
		Element departman = document.createElementNS(TARGET_NAMESPACE, "departman");
		departman.appendChild(document.createTextNode("RaÄ�unarstvo i automatika"));
		...
		prezime.appendChild(document.createTextNode("PetroviÄ‡"));
