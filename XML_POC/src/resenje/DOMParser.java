...
/**
 * 
 * Kao rezultat parsiranja generiÅ¡e se objektni reprezent XML dokumenta u vidu
 ...
 * 
 * Primer omoguÄ‡uje validaciju XML fajla u odnosu na XML Å¡emu, koja se svodi 
 * na postavljanje svojstava factory objekta uz opcionu implementaciju error 
 * handling metoda.
 * 
 * NAPOMENA: za potrebe testiranja validacije dodati nepostojeÄ‡i element ili 
	...
	public void printElement() {
	    ...
	    while (!choice.equals("*")) {
	    	...
	    	if (choice.equals("0")) {
	    		...
	    		System.out.println("\nPronadjeno " + nodes.getLength() + " \"" + elementName + "\" elemenata.");
