...
@XmlType(name = "TAdresa", namespace = "http://tipovi", propOrder = {
    "mesto",
    "ulica",
    "ulicniBroj"
})
public class TAdresa {
    ...
    @XmlElement(name = "Mesto", namespace = "http://tipovi", required = true)
    protected String mesto;
    @XmlElement(name = "Ulica", namespace = "http://tipovi", required = true)
    protected String ulica;
    @XmlElement(name = "Ulicni_broj", namespace = "http://tipovi", required = true)
